...
const cardData = [
  ...
  {
    id: 3,
    icon: <MdSettings className="text-6xl text-gray-600" />,
    title: 'SEO RANKING',
  ...
  {
    id: 4,
    icon: <MdShoppingBag className="text-6xl text-gray-600" />,
    title: 'SEO TRAFFIC',
  ...
  {
    id: 5,
    icon: <MdOutlineArrowUpward className="text-6xl text-gray-600" />,
    title: 'SEO ADVISORY',
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {cardData.map((card) => (
          <div key={card.id} className="p-8  rounded-lg flex flex-col items-center text-center">
            <div className="flex justify-center items-center mb-4 rounded-full w-24 h-24  border-2  hover:border-blue-400">
              {card.icon}
            </div>
