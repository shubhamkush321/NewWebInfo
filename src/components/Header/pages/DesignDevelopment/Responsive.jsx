...
const Responsive = () => {
  ...
  const ResponsiveData = infoDetails?.find(
    (item) => item?.items[0].title === "Wed Designing OutSourcing Company"
  );
          ...
          <div className="mb-8">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: ResponsiveData?.items[0]?.content,
              }}
            />
          </div>
        </div>
