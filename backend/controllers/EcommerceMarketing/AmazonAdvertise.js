...
const AdvertiseContent = require('../../models/EcommerceMarketing/AmazonAdvertise');
...
exports.getContentById = async (req, res) => {
  try {
    const content = await AdvertiseContent.findById(req.params.id);
    if (content) {
      res.json(content);
    } else {
...
exports.createContent = async (req, res) => {
  try {
    const contents = await AdvertiseContent.insertMany(req.body);
